...
/// Visual clone of the legacy `MedicineCard` (`lib/widgets/medicine_card.dart`),
/// adapted to the clean-architecture `Medicine` entity.
class MedicineTile extends StatelessWidget {
  final Medicine medicine;
  final void Function(String time)? onMarkTaken;

  const MedicineTile({super.key, required this.medicine, this.onMarkTaken});
