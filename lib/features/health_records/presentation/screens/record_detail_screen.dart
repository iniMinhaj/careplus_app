...
class RecordDetailScreen extends StatelessWidget {
  ...
  Widget _buildPreview() {
    // Newly uploaded local images get a real preview. Everything else
    // (remote seed rows, PDFs) keeps the icon-placeholder treatment.
    if (record.isLocalFile && record.fileType == 'image') {
      return Image.file(
        File(record.fileUrl),
        fit: BoxFit.cover,
